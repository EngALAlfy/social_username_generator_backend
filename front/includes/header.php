				...
				<div class="row-fluid">
					<div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
						<div id="hs_cos_wrapper_dnd_area-module-4" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-rich_text widget-type-rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
							...
							<form action="./generate-result.php" method="post" id="hs_cos_wrapper_dnd_area-module-4_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
								...
								<div style="text-align: center">
									<input name="custom_word" id="password-box" class="null hsimp-level password-output" type="text" placeholder="ادخل كلمة مخصصة لليوزر" />
									...
									<fieldset class="generate-settings-fieldset">
										...
										<div style="display:flex;">
											...
											<div class="generate-setting-span fieldval" style="float:none;">
												<select name="length" id="password-length-selection" class="js-example-basic-single">
										...
										<div style="display:flex;">
											...
											<div class="generate-setting-span fieldval" style="float:none;">
												<select name="service" id="service-selection" class="js-example-basic-single">
										...
										<div style="display:flex;">
											...
											<div class="generate-setting-span fieldval" style="float:none;">
												<input name="symbols" id="include-symbol-checkbox" type="checkbox" checked="checked" data-toggle="switch">
											</div>
										</div>
										...
										<div style="display:flex;">
											...
											<div class="generate-setting-span fieldval" style="float:none;">
												<input name="numbers" id="include-numbers-checkbox" type="checkbox" checked="checked" data-toggle="switch">
											</div>
										</div>
									</fieldset>
								</div>
